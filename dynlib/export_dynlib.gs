...
/// is_loaded_as_dynlib() checks if the current script is being loaded as a dynlib.
...
/// Include in the top of .dynlib source along with is_loaded_as_dynlib() function.
